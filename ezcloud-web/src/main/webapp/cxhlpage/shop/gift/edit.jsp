...
$().ready(function() {
	...
	function submit()
	{
		...
		var params={ID: ID,NAME: NAME,SHOP_ID: SHOP_ID,TOTAL_NUM: TOTAL_NUM,LEFT_NUM: LEFT_NUM,LINK_TEL: LINK_TEL,ADDRESS: ADDRESS,REMARK: REMARK}
		$.ajax({
...
<body>
	...
	<form id="inputForm" action="save.do" method="post">
		...
		<tr>
				...
				<td>
					<input type="text" id="LEFT_NUM" name="LEFT_NUM" class="text" maxlength="200" value="${row.TOTAL_NUM }" />
				</td>
			</tr>
		<tr>
				<th>
