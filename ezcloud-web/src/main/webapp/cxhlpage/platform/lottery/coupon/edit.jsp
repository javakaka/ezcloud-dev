		...
		<table class="input">
			<tr>
				...
				<td>
					...
					<input type="hidden" id="COUPON_ID" name="COUPON_ID" class="text" maxlength="200" value="${row.COUPON_ID }" />
					<input type="text" id="COUPON_NAME" name="COUPON_NAME" class="text" maxlength="200" value="${row.COUPON_NAME }" readonly/>
