	...
	<form id="inputForm" action="save.do" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="hidden" id="GIFT_ID" name="GIFT_ID" class="text" maxlength="200" value="" />
					<input type="text" id="GIFT_NAME" name="GIFT_NAME" class="text" maxlength="200" value="" readonly/>
			...
			<tr>
				...
				<td>
					<input type="text" id="LOTTERY_NUM" name="LOTTERY_NUM" class="text"  maxlength="200" value=""/>(数量不能超过优惠券的剩余数量)
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="YEAR"name="YEAR" class="text Wdate"onfocus="WdatePicker({dateFmt: 'yyyy'});"  maxlength="200" value=""/>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="MONTH" name="MONTH" class="text Wdate" onfocus="WdatePicker({dateFmt: 'MM'});" maxlength="200" value=""/>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="DAY" name="DAY" class="text Wdate" onfocus="WdatePicker({dateFmt: 'dd'});" maxlength="200" value=""/>
				</td>
			</tr>
			<!-- 
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="REMARK" name="REMARK" class="text" maxlength="500px" value="" style="width:350px;"  />
				</td>
			</tr>
			<tr>
				<th>
