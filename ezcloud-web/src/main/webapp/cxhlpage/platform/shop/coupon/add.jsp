...
$().ready(function() {
	...
	function submit()
	{
		...
		var params={NAME: NAME,SHOP_ID: SHOP_ID,RAW_PRICE: RAW_PRICE,COUPON_PRICE: COUPON_PRICE,COUPON_UNIT: COUPON_UNIT,TOTAL_NUM: TOTAL_NUM,IS_COUPON: IS_COUPON,SUMMARY: SUMMARY,REMARK: REMARK}
		$.ajax({
...
<body>
	...
	<form id="inputForm" action="save.do" method="post">
		...
		<tr>
				...
				<td>
					<input type="text" id="RAW_PRICE" name="RAW_PRICE" class="text" maxlength="200" value="" />
				</td>
			</tr>
		<tr>
				<th>
				...
				<td>
					<input type="text" id="COUPON_PRICE" name=""COUPON_PRICE"" class="text" maxlength="200" value="" />
				</td>
			</tr>
		<tr>
				<th>
				...
				<td>
					<input type="text" id="COUPON_UNIT" name="COUPON_UNIT" class="text" maxlength="200" value="" />
				</td>
			</tr>
		<tr>
				<th>
