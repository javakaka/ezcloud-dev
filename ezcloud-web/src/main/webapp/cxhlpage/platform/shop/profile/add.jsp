...
$().ready(function() {
	...
	function submit()
	{
		...
		//REMARK =$("#editor").val();
		//alert(REMARK);
		var params={C_NAME: C_NAME,TYPE: TYPE,PROVINCE_ID: PROVINCE,CITY_ID: CITY,ZONE_ID: REGION,LINK_NAME: LINK_NAME,LINK_TEL: LINK_TEL,LONGITUDE: LONGITUDE,LATITUDE: LATITUDE,ADDRESS: ADDRESS,STAR: STAR,REMARK: REMARK,DETAIL: DETAIL,AVERAGE_COST: AVERAGE_COST}
		$.ajax({
	...
	<form id="inputForm" action="save.do" method="post">
		...
		<tr>
			...
			<td>
				...
				<input type="text" id="C_NAME" name="C_NAME" class="text" maxlength="200" value="" />
			</td>
		</tr>
		<tr>
			<th>
			...
			<select  id="TYPE" name="TYPE" class="text" style="width:190px;" >
				...
				<c:forEach items="${shop_type_list}" var="row" varStatus="status">
		...
		<tr>
				...
				<td>
					<input type="text" id="LINK_NAME" name="LINK_NAME" class="text" maxlength="200" value="" />
				</td>
			</tr>
		<tr>
				<th>
		...
		<tr>
				...
				<td>
					<input type="text" id="LONGITUDE" name="LONGITUDE" class="text" maxlength="200" value="" />
				</td>
			</tr>
		<tr>
				<th>
				...
				<td>
					<input type="text" id="LATITUDE" name="LATITUDE" class="text" maxlength="200" value="" />
				</td>
			</tr>
		<tr>
				<th>
		...
		<tr>
				...
				<td>
					<input type="text" id="AVERAGE_COST" name="AVERAGE_COST" class="text" maxlength="200" value="" />
				</td>
			</tr>
		<tr>
				<th>
				...
				<td>
					<textarea cols="50" rows="5" id="REMARK" name="REMARK" ></textarea>
				</td>
			</tr>
		<tr>
				<th>
