	...
	<form id="listForm" action="list.do" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="GIFT_NAME">礼品名称</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="EXCHANGE_NUM">已兑换数量</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.GIFT_NAME}">${row.GIFT_NAME}</span>
					</td>
					<td>
					...
					<td>
						<span title="${row.EXCHANGE_NUM}">${row.EXCHANGE_NUM}</span>
					</td>
					<td>
					...
					<td>
						<a href="exchange.do?id=${row.ID}">兑奖</a>
					<!--
