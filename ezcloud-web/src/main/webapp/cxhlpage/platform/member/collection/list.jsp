	...
	<form id="listForm" action="list.do" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="COLLECTION_NAME">收藏的商家名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="CREATE_TIME">收藏时间</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.COLLECTION_NAME}">${row.COLLECTION_NAME}</span>
					</td>
					<td>
