...
<body>
	...
	<form id="listForm" action="PayList.do" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'RENT_NAME'}"> class="current"</c:if> val="CODE">房源编号</a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'RENT_NAME'}"> class="current"</c:if> val="RENT_NAME">租客姓名</a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'RENT_TELEPHONE'}">class="current"</c:if> val="RENT_TELEPHONE">租客电话</a>
						</li>
						<li>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="RENT_TELEPHONE">租客电话</a>
				</th>
				<th>
				...
				<tr>
					...
					<td>
						<c:choose>
							...
							<c:otherwise>${row.RENT_NAME}</c:otherwise>
						</c:choose>
					</td>
					<td>
						<c:choose>
							<c:when test="${row.RENT_TELEPHONE=='' }">--</c:when>
							<c:otherwise>${row.RENT_TELEPHONE}</c:otherwise>
						</c:choose>
					</td>
					<td>
