...
<body>
	<div class="path">
		<cc:message key="framework.nav.index" /> &raquo;提现申请列表
	...
	<input type="hidden" id="user_id" name="user_id" value="<c:if test="${user_id !=''}">${user_id}</c:if>" />
				...
				<div class="menuWrap">
					...
					<div class="popupMenu">
						<ul id="filterOption" class="check">
							...
							<li>
								<a href="javascript:;" name="status" val="2" <c:if test="${status == '2'}"> class="checked" </c:if> >审核不通过</a>
							</li>
							<li>
								<a href="javascript:;" name="status" val="3" <c:if test="${status == '3'}"> class="checked" </c:if> >审核通过</a>
							</li>
							<li class="separator">
								<a href="javascript:;" name="status" val="4" <c:if test="${status == '4'}"> class="checked" </c:if> >已打款</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'NAME'}"> class="current"</c:if> val="TELEPHONE">申请人电话</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="NAME">申请人姓名</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="TELEPHONE">申请人电话</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="MONEY">提现金额</a>
				</th>
				<th>
