...
<body>
	...
	<form id="inputForm" action="update.do" method="post">
		<input type="hidden" id="ID" name="ID" class="text" maxlength="200" value="" />
		<table class="input">
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" id="VERSION_NAME" name="VERSION_NAME" class="text" maxlength="200" value="" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="VERSION" name="VERSION" class="text" maxlength="200" value=""/>
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<textarea id="editor"  name="REMARK" class="editor"></textarea>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					...
					<input type="button" id="backBtn" class="button" value="返回" onclick="javascript:window.history.go(-1)"/>
				</td>
			</tr>
		</table>
	</form>
